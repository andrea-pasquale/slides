...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    direction: {
        ...
        default: textImgDirection;
    };
}, {
    props: any;
    isReverse: import("vue").ComputedRef<boolean>;
    ...
    AsGraphic: import("vue").DefineComponent<{
        type: {
            type: StringConstructor;
            default: import("../as-graphic/const").graphicType;
            validator: (val: string) => boolean;
        };
    }, {
        props: any;
        graphic: import("vue").ComputedRef<any>;
